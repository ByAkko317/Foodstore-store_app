...
import { deleteAddress, getAddresses, updateAddress, } from "../api/addresses.service";

import type { IAddress, AddressPayload, AddressListResponse, } from "../types/IAddress";
...
export const AddressesPage = () => {
  ...
  const [addressActive, setAddressActive] =
    useState<IAddress | null>(null);

  const [addressToView, setAddressToView] =
    useState<IAddress | null>(null);
    ...
    return (
      <div className="w-full max-w-5xl mx-auto px-4 py-6">
        <p className="text-red-600">
          Hubo un error al cargar las direcciones.
        </p>
      </div>
    );
  }
          ...
          {addresses.length === 0 && (
            <div className="py-16 text-center text-gray-400">
              ...
              <p className="text-sm mt-1">
                Agregá una dirección luego de continuar la compra
